...
The code of value iteration algorithm is shown in Listing~\ref{lst:q6}. The code is available via this link: \url{https://github.com/jiekeshi/IS711/blob/main/Value_iteration.py}.
